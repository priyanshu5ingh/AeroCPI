...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('total_all_eligible_routes_passengers', sa.Integer(), nullable=False, server_default='0'),
    ...
    op.create_table(
        ...
        sa.Column('dgca_route_traffic_share', sa.Float(), nullable=False),
        sa.Column('dgca_basket_weight', sa.Float(), nullable=False),
        sa.Column('dgca_route_traffic_share_unit', sa.String(), nullable=False, server_default='share_of_all_eligible_traffic'),
        sa.Column('dgca_basket_weight_unit', sa.String(), nullable=False, server_default='weight_within_selected_basket'),
