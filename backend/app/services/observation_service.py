...
class ObservationService:
    ...
    def ingest_raw_quote(cls, db: Session, raw_input: RawQuoteInput) -> Observation:
        ...
        obs = Observation(
            ...
            base_fare=canon_dict["base_fare"] if canon_dict["base_fare"] is not None else 0.0,
            taxes=canon_dict["taxes"] if canon_dict["taxes"] is not None else 0.0,
            mandatory_fees=canon_dict["fees"] if canon_dict["fees"] is not None else 0.0,
